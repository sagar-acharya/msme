    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6" style="border: 1px solid #5964C6;">
                <!-- Contacts Form -->
                <form class="contact_form" action="/msme-udyam-form-submit" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    1. EXISTING UDYOG AADHAAR NO./ मौजूदा उद्योग आधार नं *
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="input-group">
                                    <input class="form-control {{ $errors->has('existing_aadhar_number') ? 'is-invalid' : ''}}"  name="existing_aadhar_number" id="existing_aadhar_number" value="{{old('existing_aadhar_number')}}" required="" placeholder="" type="text">
                                    @if($errors->has('existing_aadhar_number'))
                                    <div class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('existing_aadhar_number') }}</strong>
                                    </div>
                                    @endif
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block">
                                    3. Are you interested to get registered on Government e-Market(GeM) Portal
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block">
                                    4. Are you interested to get registered on TReDS Portal
                                </label>
                                <div class="input-group ">
                                    <div class="form-check form-check-inline">
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    5. Your Aadhaar No./ आपका आधार नं
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="input-group">
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    6. Name of Entrepreneur/ Applicant/ उद्यमी का नाम
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <!-- End Input -->
                         ...
                         <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    7. Social Category / सामाजिक वर्ग
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    9. Physically Handicapped / शारीरिक रूप से विकलांग
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    10. Name of Business/ Enterprise / उद्यम का नाम
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    11. Type of Organisation / संगठन के प्रकार
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    12. PAN CARD NUMBER / पैन कार्ड नंबर
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    13. Location of Plant (Address) / संयंत्र के स्थान
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12" id="office-address-group">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    14. Office Address / आधिकारिक पता Same As Plant Address
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    17. Date of Commencement of Business / उद्यम के प्रारंभ की तिथि
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    18. Bank Account Number / बैंक खाता संख्या
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    20. Main Business Activity of Enterprise / इकाई का प्रमुख गतिविधि
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="input-group ">
                        ...
                        <div class="col-sm-12 mb-12" id="nic_code_id_group">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    21. NIC 2 Digit Code - Choose primary Business Activity
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="input-group">
                        ...
                        <!-- End Input -->
                            ...
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    22. Additional details about Business /व्यापार के बारे में अतिरिक्त जानकारी
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    23. Number of employees / व्यक्ति नियोजित
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    24. Investment in Plant and Machinery (Amount in Lacs) / निवेश
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-sm-12 mb-12">
                            <div class="form-group">
                                <label class="h6 small d-block text-uppercase">
                                    25. Attach your Aadhaar Card (Optional)
                                </label>
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <ol style="color: #5964c6;font-weight:500;font-size:18px;">
                    <li>
                        Existing Udyog Aadhaar No : Please fill applicant 12 digit Aadhaar number in the appropriate field.<br/>
